...
| 항목 | 현재 값 |
| --- | --- |
| Portal image | `ich6648/trident-portal:v97.153` |
| twin-hub image | `ich6648/trident-twin-hub:v0.1.10` |
...
| Scene artifact | `/mnt/Trident-Twin-520d314/stages/trident_lakehouse_twin_*.usda` 중 운영자가 선택한 최신 생성본 |
...
- Cluster rollout: `trident-portal:v97.153`, `trident-twin-hub:v0.1.10`
...
```bash
docker build -f Dockerfile.twin-hub -t ich6648/trident-twin-hub:v0.1.10 .
docker push ich6648/trident-twin-hub:v0.1.10
```
...
```bash
npm run build
docker build -t ich6648/trident-portal:v97.153 .
docker push ich6648/trident-portal:v97.153
```
